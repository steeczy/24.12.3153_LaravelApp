...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
            ...
            <h3 class="text-2xl font-black">Rp 10.000.000</h3>
        </div>
        <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
            ...
            <h3 class="text-2xl font-black">1.000</h3>
        </div>
        <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
        ...
        <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
            ...
            <h3 class="text-2xl font-black">20 Pesanan</h3>
        </div>
    </div>
    ...
    <div class="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
        <div class="p-8 border-b flex justify-between items-center">
            ...
            <a href="{{ url('/admin/transactions') }}" class="text-indigo-600 font-bold hover:underline">Lihat Semua</a>
        </div>
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y border-t">
                    <tr class="hover:bg-slate-50 transition">
                        <td class="px-8 py-6">
                            <p class="font-bold uppercase tracking-wide text-sm">Mirza</p>
                            <p class="text-xs text-slate-400">mirza@example.com</p>
                        </td>
                        ...
                        <td class="px-8 py-6 font-black text-indigo-600">Rp 200.000</td>
                    </tr>
                    <tr class="hover:bg-slate-50 transition">
                        <td class="px-8 py-6">
                            <p class="font-bold uppercase tracking-wide text-sm">Labib</p>
                            <p class="text-xs text-slate-400">labib@example.com</p>
                        </td>
                        ...
                        <td class="px-8 py-6 font-black text-indigo-600">Rp 60.000</td>
                    </tr>
                    <tr class="hover:bg-slate-50 transition">
                        <td class="px-8 py-6">
                            <p class="font-bold uppercase tracking-wide text-sm">Reval</p>
                            <p class="text-xs text-slate-400">reval@example.com</p>
                        </td>
